<div
  class="flex col-span-1  flex-col items-start justify-between w-full h-auto gap-5 p-4 border-2 rounded-regular border-primary-400 tablet_landscape:max-w-[380px]"
>
  <div class="flex flex-col items-start gap-6">
    <div class="flex flex-col items-start gap-2">
      <div class="flex flex-row gap-3 mb-2">
        <div
          class="w-3 bg-black rounded-full aspect-square bg-gradient-to-br from-primary-500 to-primary-400"
        ></div>
        <div
          class="w-3 bg-black rounded-full aspect-square bg-gradient-to-br from-primary-500 to-primary-400"
        ></div>
        <div
          class="w-3 border-2 border-dotted rounded-full border-primary-500/30 bg-primary-500/30 aspect-square"
        ></div>
      </div>
      <h3
    ...
    <ul class="flex flex-col gap-2">
      <li class="flex flex-row items-center gap-2">
        <div
          class="flex items-center justify-center pb-[6px] pr-[6px] pl-[7px] pt-[7px] bg-gradient-to-br from-primary-500 to-primary-400 rounded-full aspect-square"
        >
          <svg
            width="10"
            height="8"
      ...
      <li class="flex flex-row items-center gap-2 opacity-60">
        <div
          class="flex items-center justify-center p-[7px] bg-gradient-to-br from-primary-500 to-primary-400 rounded-full aspect-square"
        >
          <svg
            width="10"
            height="10"
